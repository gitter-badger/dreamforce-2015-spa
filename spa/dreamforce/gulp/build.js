...
gulp.task('html', ['wiredep', 'injector:css', 'injector:js', 'partials'], function () {
  ...
  return gulp.src('src/*.html')
    ...
    .pipe(gulp.dest('../../resource-bundles/dreamforce.resource'))
...
gulp.task('images', function () {
  return gulp.src('src/assets/images/**/*')
    ...
    .pipe(gulp.dest('../../resource-bundles/dreamforce.resource/assets/images/'))
...
gulp.task('fonts', function () {
  return gulp.src($.mainBowerFiles())
    ...
    .pipe($.flatten())
    .pipe(gulp.dest('../../resource-bundles/dreamforce.resource/fonts/'))
